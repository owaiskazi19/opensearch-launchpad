...
mcp.tool()(create_bedrock_agentic_model)
mcp.tool()(create_agentic_search_agent)
mcp.tool()(create_agentic_search_conversational_agent)
mcp.tool()(create_agentic_search_flow_agent)
mcp.tool()(create_agentic_search_pipeline)
mcp.tool()(index_doc)
